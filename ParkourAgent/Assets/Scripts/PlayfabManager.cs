    ...
    public void changeDisplayName()
    {
        ...
        if(name.Length >= 3)
        {
            ...
            }, result =>
            {
                ...
                UI_Manager.instance.nameErrorTxt.text = "";
                Debug.Log("The player's display name is now: " + result.DisplayName);
            }, error => 
            {
                string errorMsg = error.ErrorMessage;
                Debug.LogError(errorMsg);
                UI_Manager.instance.nameErrorTxt.text = errorMsg;
            });
        }
        else
        {
            UI_Manager.instance.nameErrorTxt.text = "Name must be 3 or more characters";
        }
